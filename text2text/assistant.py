...
class Assistant(t2t.Transformer):
  ...
  def __init__(self, **kwargs):
    pretrained_model = "databricks/dolly-v2-3b"
    ...
    self.__class__.pipeline = InstructionTextGenerationPipeline(model=model, tokenizer=tokenizer)

  def transform(self, input_lines, src_lang='en', **kwargs):
    input_lines = t2t.Transformer.transform(self, input_lines, src_lang=src_lang, **kwargs)
    res = self.__class__.pipeline([input_lines])
